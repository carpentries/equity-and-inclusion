...
head(instructors_by_country)
```

```{r instructors-by-gender}
...
get_instructors_by_gender_percent <- function(country_var, .data = instructors_by_gender) {
    extract_percentage(.data, .var = country, .value = country_var)
}


head(instructors_by_gender)
```