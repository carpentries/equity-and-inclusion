...
dc_pre_2017 <- readr::read_csv("https://raw.githubusercontent.com/carpentries/equity-and-inclusion/master/data/dcpre-2017.csv")
```

```{r include=FALSE}
# Loading dataset for the 2017 archived pre-workshop survey demographics for Data Carpentry
dc_archived_pre_2017 <- readr::read_csv("https://raw.githubusercontent.com/carpentries/equity-and-inclusion/master/data/dcpre-archived-2017.csv")
```
...
```{r dc_2017_position_archived_survey}
...
```{r dc_2017_gender_archived_survey}
# What is your gender?
...
```{r dc_2017_race_ethnicity_archived_US}
